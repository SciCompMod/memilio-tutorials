...
int main()
{
    ...
    // We export the results for region 0 as csv which is saved in the current folder. Then we can plot the results
    // using plot_secir_results.py.
    auto export_status = result_region0.export_csv("../../cpp-tutorials/results_ode_region0.csv");
}
