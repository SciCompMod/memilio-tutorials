...
int main()
{
    ...
    // TODO: Set the initial values of the Exposed compartment per subcompartment. The total number of individuals in
    // the Exposed compartment should be 500.
    std::vector<ScalarType> initial_exposed                  = {};
    ...
    // TODO: Set the probability of ICU admission of already hospitalized patients to 0.25.
