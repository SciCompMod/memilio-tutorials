...
def _():
    num_regions = 2
    num_age_groups = 3
    model = ...  # TODO create the model using oseir_metapop.Model(...)
...
def _(AgeGroup, mio, model, num_age_groups, num_regions, oseir_metapop):
    ...
    # TODO Seed the model with 10 exposed individuals in the first region and second age group
    return
...
def _(dt, model, oseir_metapop, t0, tmax):
    ...
    result = ...  # TODO: run the simulation using oseir_metapop.simulate and store the result in `result`
    return (result,)
...
def _(oseir_metapop, result):
    result_interpolated = ...  # TODO: interpolate the simulation result using oseir_metapop.interpolate_simulation_result
...
def _(num_age_groups, oseir_metapop, plt, result_interpolated):
    ...
    # TODO: sum the Infected compartment across all age groups for region 0 and region 1
    Infected_0 = ...
    Infected_1 = ...
