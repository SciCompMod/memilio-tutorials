...
def _():
    ...
    return AgeGroup, ContactMatrix, ContactMatrixGroup, read_mobility_plain
...
app._unparsable_cell(
    ...
    # TODO: Make sure the following parameters are set for all age groups
            model.parameters.TimeInfectedNoSymptoms[ ] = parameters[f"TimeInfectedNoSymptoms{ }"]
            model.parameters.TransmissionProbabilityOnContact[ ] = parameters[f"TransmissionProbabilityOnContact{ }"]
            model.parameters.RecoveredPerInfectedNoSymptoms[ ] = parameters[f"RecoveredPerInfectedNoSymptoms{ }"]
    """,
    name="_"
)
...
@app.cell
def _(abc):
    # TODO: Run the inference for 6 populations.
    history = abc.run()
    return (history,)
...
def _(history, plt):
    ...
    # TODO: Plot a kde matrix of the infered paramters.
