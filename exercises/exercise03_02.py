...
@app.cell
def _(Damping, model, np):
    # TODO: Add a damping representing full homeschooling: a 40% reduction, starting at t=40.0,
    # using the SAME level and type as the day-10 school-closure damping above, so that it
    # replaces that damping instead of adding a third contribution.
    return
